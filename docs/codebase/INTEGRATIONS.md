...
| ------------------------------ | ----------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------------------- |
| GitHub Actions (build + Pages) | CI/CD                                     | `pnpm install` + JS/Rust tests + lint + build on PR; Rust `wasm-pack` build before Pages deploy on `main` push | GitHub token (Pages `id-token` for OIDC deploy) | high (release path) | `.github/workflows/build.yml`, `.github/workflows/test.yml`, `.github/workflows/deploy-pages.yml` |
